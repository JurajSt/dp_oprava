        ...
        for f in ephfiles:
            ...
            for sat in satellite:
                ...
                for w in range(len(sinelexx)):
                    ...
                    #print x[0], SNR1[0], timenum[0]
                    #print x[0], SNR2[0], timenum[0]
                    ...
                    modelSNR1, residuals1, SNR1_vector = model.modelSNRxx(timenum, SNR1, deg)
                    modelSNR1_1, residuals1_1, SNR1_vector_1 = model.modelSNRxx(x, SNR1_vector, deg)

                    modelSNR2, residuals2, SNR2_vector = model.modelSNRxx(timenum, SNR2, deg)
                    modelSNR2_1, residuals2_1, SNR2_vector_1 = model.modelSNRxx(x, SNR2_vector, deg)

                    plt.subplot(2, 1, 1)
                    plt.plot(timenum, residuals1,'o', color='red', label='SNR1')
                    plt.ylabel('volt')

                    plt.subplot(2, 1, 2)
                    plt.plot(timenum, SNR2_vector_1, color='blue', label='SNR2')
                    plt.ylabel('volt')
                    plt.show()
                    ...
                    try:        # skuska imporu kniznice Astropy, ak  nenaimportuje skusi kniznicu scipy ak ani ta sa nenaimportuje vypocet skonci.
                        ...
                        powerS1 = LombScargle(x, SNR1_vector_1).power(freqS1)
                        powerS2 = LombScargle(x, SNR2_vector_1).power(freqS2)
